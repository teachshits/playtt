...
class Player < ActiveRecord::Base
  ...
  validates  :city, :first_name,  :last_name, :level, presence: true, :length => { :maximum => 25 }
  ...
  validates :level, :inclusion => {:in => ['Слабый новичек', 'Новичек','Игрок','Профи'], :message => 'Неверный уровень игры'}
